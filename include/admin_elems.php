...
function getAccounts () {
    ...
    $query = 'SELECT account_id, collab_id, account_username, account_group, account_enabled, zile_concediu, zile_report FROM '. $schema . '.accounts ORDER BY account_enabled DESC';
