...
function populateUsers() {
  ...
  accountsObject.forEach(element => {
    ...
    '<td><a class="waves-effect waves-light btn modal-trigger btn-small" href="#salaryModal" onclick="$(\'#addNewSalaryDiv\').removeClass(\'hidden\'); userID=' + element.collab_id +'">Date Salariu</a></td>'+
...
function addNewSalary(user_id) {
  ...
  $('#addNewSalaryDiv').addClass('hidden');
