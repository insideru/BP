...
function popupProjInfo(proj_id) {
  $("#viewProjBody").load("proto-viewproj.html", function() {
    ...
    if (isAdmin && location.search.substring(1,10) == 'page=admin') $('#prjBtn').html(`<a class="right waves-effect waves-green btn" onclick="modProj(${proj_id})">Modifica proiect</a>`);
