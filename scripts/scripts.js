        ...
        tmpltData.forEach(sto => {
          ...
          switch (Number(sto.type)) {
            case 3: //text
                    ...
                    break;
            case 1: //bifa
                    newRow = `<tr><td width="20"><i class="bi bi-arrows-move sorter" style="color: gray; cursor: pointer;"></i></td><td id="detailName_${detailNumber}">${detailName}</td><td><select id="detailValue_${detailNumber}"><option value="?" disabled selected>Alege Da sau Nu</option><option value="1">Da</option><option value="0">Nu</option></select></td><td width="10"><i class="bi bi-trash3 cursor-pointer-hover-red" onclick="removeItem(0, ${detailNumber})"></i></td></tr>`;
                    break;
            case 0: //textarea
...
function addProjDetail() {
  ...
  switch (Number($('#addDetailType').val())) {
    case 3: //text
            ...
            break;
    case 1: //bifa
            newRow = `<tr><td width="20"><i class="bi bi-arrows-move sorter" style="color: gray; cursor: pointer;"></i></td><td onclick="renameProjStuff('${detailName}', 0, ${detailNumber})" id="detailName_${detailNumber}">${detailName}</td><td><select id="detailValue_${detailNumber}"><option value="?" disabled selected>Alege Da sau Nu</option><option value="1">Da</option><option value="0">Nu</option></select></td><td width="10"><i class="bi bi-trash3 cursor-pointer-hover-red" onclick="removeItem(0, ${detailNumber})"></i></td></tr>`;
            break;
    case 0: //textarea
